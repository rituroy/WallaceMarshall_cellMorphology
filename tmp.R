...
if (computerFlag=="cluster") {
    ...
    dirSrc2=paste(dirSrc,"functions/",sep="")
}
...
for (datVer in datVerList) {
    ...
    if (computerFlag=="") annRpart=read.table(paste("rpart.txt",sep=""),sep="\t",h=T,quote="",comment.char="",as.is=T,fill=T)

    library(marray)
    #library(fpc)
    library(NbClust)

    #source(paste(dirSrc2,"heatmap.5.R",sep=""))
    #source(paste(dirSrc2,"heatmapAcgh.7.R",sep=""))
    #source(paste(dirSrc2,"heatmap.5.2.R",sep=""))
    #source(paste(dirSrc2,"heatmap.5.4.R",sep=""))
    #source(paste(dirSrc2,"heatmap.5.5.R",sep=""))
    #source(paste(dirSrc2,"heatmapAcgh.7.1.R",sep=""))
    source(paste(dirSrc2,"heatmap.5.6.R",sep=""))
    source(paste(dirSrc2,"heatmapAcgh.7.3.R",sep=""))
